...
<model ref="r:c6049a37-e654-4a02-85d3-76247a0085db(jetbrains.mps.baseLanguageExt.test.thinlet@tests)">
  ...
  <imports>
    ...
    <import index="bm3g" ref="r:a3cbed52-2cb3-4f5f-bddd-c7d6bae97d47(jetbrains.mps.baseLanguageExt.test.code.thinlet)" />
