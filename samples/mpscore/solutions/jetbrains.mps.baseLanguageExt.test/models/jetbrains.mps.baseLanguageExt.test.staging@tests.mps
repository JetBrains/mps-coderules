...
<model ref="r:462704f1-38c3-45db-b49f-e3ea4de2770d(jetbrains.mps.baseLanguageExt.test.staging@tests)">
  ...
  <imports>
    <import index="uku4" ref="r:1ea6d6af-a343-425c-8096-c1bf7ddb3cb0(jetbrains.mps.baseLanguageExt.test.code.staging)" />
  ...
  <node concept="1lH9Xt" id="68TJRU2gLGD">
