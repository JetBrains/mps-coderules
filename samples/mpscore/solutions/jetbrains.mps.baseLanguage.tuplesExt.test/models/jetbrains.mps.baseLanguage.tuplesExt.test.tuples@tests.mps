...
<model ref="r:7629dcf7-5e1f-426d-b89d-05e2a613747a(jetbrains.mps.baseLanguage.tuplesExt.test.tuples@tests)">
  ...
  <imports>
    ...
    <import index="qwqz" ref="r:42bdc5da-5ab1-401b-822c-d8fc1e4f2876(jetbrains.mps.baseLanguage.tuplesExt.test.tuples)" />
  </imports>
  <registry>
