...
<model ref="r:561d5575-77bb-481e-a4fe-d899693312ea(samples.fitch.demo.herbrandLogic@tests)">
  ...
  <imports>
    ...
    <import index="fr15" ref="r:8762d21a-5bfe-45a2-8a7c-66fa5147f3db(samples.fitch.demo.herbrandLogic)" />
  </imports>
  <registry>
  ...
  <node concept="1lH9Xt" id="5RH_cL_9FJF">
    ...
    <node concept="1LZb2c" id="5s5QomKHHK1" role="1SL9yI">
      ...
      <node concept="3clFbS" id="5s5QomKHHK6" role="3clF47">
        <node concept="2Hmddi" id="27bTNFfbwWt" role="3cqZAp">
          <node concept="2OqwBi" id="27bTNFfbwWu" role="2Hmdds">
            <node concept="2OqwBi" id="27bTNFfbwWv" role="2Oq$k0">
              <node concept="2YIFZM" id="27bTNFfbwWw" role="2Oq$k0">
                <ref role="1Pybhc" to="tj24:1N_0WA5JxZO" resolve="TypecheckingTestHelper" />
                <ref role="37wK5l" to="tj24:27bTNFfaOo$" resolve="ofNode" />
                <node concept="2OqwBi" id="27bTNFfbZAI" role="37wK5m">
                  <node concept="2WthIp" id="27bTNFfbZAJ" role="2Oq$k0" />
                  <node concept="2XshWL" id="27bTNFfbZAK" role="2OqNvi">
                    <ref role="2WH_rO" node="35YJGAJTxCf" resolve="resolve" />
                    <node concept="2tJFMh" id="27bTNFfbZAL" role="2XxRq1">
                      <node concept="ZC_QK" id="27bTNFfbZAM" role="2tJFKM">
                        <ref role="2aWVGs" to="fr15:3w0n0hzkMd2" resolve="Example" />
                      </node>
                    </node>
                  </node>
                </node>
                <node concept="1jxXqW" id="27bTNFfbZCJ" role="37wK5m" />
              </node>
              <node concept="liA8E" id="27bTNFfbwWz" role="2OqNvi">
                <ref role="37wK5l" to="tj24:27bTNFfaVLW" resolve="skipLocal" />
              </node>
            </node>
            <node concept="liA8E" id="27bTNFfbwW$" role="2OqNvi">
    ...
    <node concept="2XrIbr" id="35YJGAJTxCf" role="1qtyYc">
      ...
      <node concept="3Tqbb2" id="35YJGAJTxCp" role="3clF45">
        <ref role="ehGHo" to="bw37:3w0n0hzg5do" resolve="HerbrandProof" />
      </node>
              ...
              <node concept="3clFbF" id="35YJGAJT$eE" role="3cqZAp">
                <node concept="37vLTI" id="35YJGAJT$eG" role="3clFbG">
                  <node concept="1PxgMI" id="35YJGAJT$36" role="37vLTx">
                    <node concept="chp4Y" id="5RH_cL_9FK8" role="3oSUPX">
                      <ref role="cht4Q" to="bw37:3w0n0hzg5do" resolve="HerbrandProof" />
                    </node>
