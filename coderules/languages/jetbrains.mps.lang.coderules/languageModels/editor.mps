...
<model ref="r:3345f3eb-f61a-42bd-88eb-d9032a80e9a6(jetbrains.mps.lang.coderules.editor)">
  ...
  <imports>
    ...
    <import index="zer4" ref="r:34927e48-bf8d-4708-a63c-2a3e4a3e490e(jetbrains.mps.dataform.editor)" />
        ...
        <node concept="mot77" id="7km57PkaAqn" role="VblUZ">
          <node concept="3clFbS" id="7km57PkaAqo" role="2VODD2">
            <node concept="3clFbF" id="7km57PkaAuV" role="3cqZAp">
              <node concept="10M0yZ" id="JOGAOsxcaI" role="3clFbG">
                <ref role="3cqZAo" to="zer4:1iWwVK2_CSV" resolve="FG_KEYWORD" />
                <ref role="1PxDUh" to="zer4:7ksQUDZpwgy" resolve="CustomColors" />
              </node>
            </node>
          </node>
        </node>
        ...
        <node concept="mot77" id="7km57PkbneD" role="VblUZ">
          <node concept="3clFbS" id="7km57PkbneE" role="2VODD2">
            <node concept="3clFbF" id="7km57PkbneF" role="3cqZAp">
              <node concept="10M0yZ" id="JOGAOsxcaH" role="3clFbG">
                <ref role="3cqZAo" to="zer4:1iWwVK2_CSV" resolve="FG_KEYWORD" />
                <ref role="1PxDUh" to="zer4:7ksQUDZpwgy" resolve="CustomColors" />
              </node>
            </node>
        ...
        <node concept="mot77" id="7LZcKzBE08O" role="VblUZ">
          <node concept="3clFbS" id="7LZcKzBE08P" role="2VODD2">
            <node concept="3clFbF" id="7LZcKzBFmHU" role="3cqZAp">
              <node concept="10M0yZ" id="JOGAOsxcaz" role="3clFbG">
                <ref role="3cqZAo" to="zer4:7LZcKzBExMT" resolve="BG_INJECTED_FRAGMENT" />
                <ref role="1PxDUh" to="zer4:7ksQUDZpwgy" resolve="CustomColors" />
              </node>
            </node>
          </node>
          ...
          <node concept="mot77" id="4bWqD4C4CM8" role="VblUZ">
            <node concept="3clFbS" id="4bWqD4C4CM9" role="2VODD2">
              <node concept="3clFbF" id="4bWqD4C4CMa" role="3cqZAp">
                <node concept="10M0yZ" id="JOGAOsxcaV" role="3clFbG">
                  <ref role="3cqZAo" to="zer4:4bWqD4C7sc7" resolve="FG_TERM" />
                  <ref role="1PxDUh" to="zer4:7ksQUDZpwgy" resolve="CustomColors" />
                </node>
              </node>
            </node>
        ...
        <node concept="mot77" id="1iWwVK2DTqL" role="VblUZ">
          <node concept="3clFbS" id="1iWwVK2DTqV" role="2VODD2">
            <node concept="3clFbF" id="1iWwVK2DTyA" role="3cqZAp">
              <node concept="10M0yZ" id="JOGAOsxcaA" role="3clFbG">
                <ref role="3cqZAo" to="zer4:7LZcKzBF77o" resolve="FG_LOCAL_IDENTIFIER" />
                <ref role="1PxDUh" to="zer4:7ksQUDZpwgy" resolve="CustomColors" />
              </node>
            </node>
          </node>
  ...
  <node concept="24kQdi" id="4EfgX2EvGdG">
    ...
    <node concept="3EZMnI" id="4EfgX2EvGm$" role="2wV5jI">
      <node concept="3EZMnI" id="oI9YrmS7B" role="3EZMnx">
        ...
        <node concept="1Bsynf" id="oI9YrmS7H" role="3F10Kt">
          <property role="VOm3f" value="true" />
        </node>
        <node concept="1Bt7hp" id="oI9YrmS7I" role="3F10Kt">
          <property role="VOm3f" value="true" />
        </node>
    ...
    <node concept="3ft6gV" id="1mdVbTRTSpu" role="3ft7WO">
      <node concept="3N5dw7" id="4hPXq9JmemJ" role="3ft5RZ">
        <node concept="16NfWO" id="oI9YrnjlN" role="upBLP">
          <node concept="2h3Zct" id="oI9YrnjrM" role="16NeZM">
            <property role="2h4Kg1" value="eval" />
          </node>
        </node>
  ...
  <node concept="24kQdi" id="36tQV5AmMLP">
    ...
    <node concept="3EZMnI" id="36tQV5AmMLR" role="2wV5jI">
      ...
      <node concept="3F0ifn" id="36tQV5AmMMd" role="3EZMnx">
        ...
        <node concept="pkWqt" id="7lt0LtPRnco" role="pqm2j">
          <node concept="3clFbS" id="7lt0LtPRncp" role="2VODD2">
            <node concept="3clFbF" id="7lt0LtPRnjA" role="3cqZAp">
              <node concept="2OqwBi" id="7lt0LtPRqrm" role="3clFbG">
                <node concept="2OqwBi" id="7lt0LtPRnxn" role="2Oq$k0">
                  <node concept="pncrf" id="7lt0LtPRnj_" role="2Oq$k0" />
                  <node concept="3Tsc0h" id="7lt0LtPRo2z" role="2OqNvi">
                    <ref role="3TtcxE" to="wq2x:36tQV5AmIsW" resolve="body" />
                  </node>
                </node>
                <node concept="3GX2aA" id="7lt0LtPRwni" role="2OqNvi" />
              </node>
            </node>
          </node>
        </node>
  ...
  <node concept="24kQdi" id="36tQV5AmNr7">
    ...
    <node concept="3EZMnI" id="36tQV5AmNNV" role="2wV5jI">
      ...
      <node concept="3F0ifn" id="6F9w2VbOOvP" role="3EZMnx">
        <property role="3F0ifm" value="}" />
        <ref role="1k5W1q" to="tpen:hFD5_7H" resolve="RightBrace" />
        <node concept="pVoyu" id="6F9w2VbOOAj" role="3F10Kt">
          <property role="VOm3f" value="true" />
        </node>
      </node>
    </node>
  ...
  <node concept="24kQdi" id="7lt0LtQg3vn">
    <ref role="1XX52x" to="wq2x:7lt0LtQg3tE" resolve="ConstantExpressionItem" />
    <node concept="3EZMnI" id="7lt0LtQg3vp" role="2wV5jI">
      <node concept="3EZMnI" id="7lt0LtQg3vq" role="3EZMnx">
        ...
        <node concept="3F1sOY" id="7lt0LtQg3vy" role="3EZMnx">
          <ref role="1NtTu8" to="wq2x:7lt0LtQg3vl" resolve="code" />
  ...
  <node concept="IW6AY" id="xaaVXv4Ni3">
    ...
    <node concept="1Qtc8_" id="xaaVXv4Ni4" role="IW6Ez">
      <node concept="IWgqT" id="xaaVXv4Nig" role="1Qtc8A">
        <node concept="1hCUdq" id="xaaVXv4Nii" role="1hCUd6">
          <node concept="3clFbS" id="xaaVXv4Nik" role="2VODD2">
            <node concept="3clFbF" id="xaaVXv4NiB" role="3cqZAp">
              <node concept="Xl_RD" id="xaaVXv4NiA" role="3clFbG">
                <property role="Xl_RC" value="principal" />
              </node>
            </node>
          </node>
        </node>
        <node concept="IWg2L" id="xaaVXv4Nim" role="IWgqQ">
          <node concept="3clFbS" id="xaaVXv4Nio" role="2VODD2">
            <node concept="3clFbF" id="xaaVXv4OmQ" role="3cqZAp">
              <node concept="2OqwBi" id="xaaVXv4PEE" role="3clFbG">
                <node concept="2OqwBi" id="xaaVXv4O_a" role="2Oq$k0">
                  <node concept="7Obwk" id="xaaVXv4OmP" role="2Oq$k0" />
                  <node concept="3TrcHB" id="xaaVXv4P7T" role="2OqNvi">
                    <ref role="3TsBF5" to="wq2x:xaaVXv4NiS" resolve="principal" />
                  </node>
                </node>
                <node concept="tyxLq" id="xaaVXv4Q80" role="2OqNvi">
                  <node concept="3clFbT" id="xaaVXv4Q9F" role="tz02z">
                    <property role="3clFbU" value="true" />
                  </node>
                </node>
              </node>
        ...
        <node concept="27VH4U" id="xaaVXv4NiI" role="2jiSrf">
          <node concept="3clFbS" id="xaaVXv4NiJ" role="2VODD2">
            <node concept="3clFbF" id="xaaVXv4NjP" role="3cqZAp">
              <node concept="3fqX7Q" id="xaaVXv4Om_" role="3clFbG">
                <node concept="2OqwBi" id="xaaVXv4OmB" role="3fr31v">
                  <node concept="7Obwk" id="xaaVXv4OmC" role="2Oq$k0" />
                  <node concept="3TrcHB" id="xaaVXv4OmD" role="2OqNvi">
                    <ref role="3TsBF5" to="wq2x:xaaVXv4NiS" resolve="principal" />
                  </node>
                </node>
              </node>
      ...
      <node concept="3cWJ9i" id="xaaVXv4Ni8" role="1Qtc8$">
        <node concept="CtIbL" id="xaaVXv4Nia" role="CtIbM">
          <property role="CtIbK" value="RIGHT" />
        </node>
      </node>
    </node>
